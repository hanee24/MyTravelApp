...
public class SectionedExpandableLayoutHelper implements SectionStateChangeListener {
    ...
    //data list
    private LinkedHashMap<Section, ArrayList<Area>> mSectionDataMap = new LinkedHashMap<Section, ArrayList<Area>>();
    ...
    public void addSection(String section, int sectionId, ArrayList<Area> items) {
        Section newSection;
        mSectionMap.put(section, (newSection = new Section(section,sectionId)));
        mSectionDataMap.put(newSection, items);
    }

    public void addItem(String section, Area item) {
        mSectionDataMap.get(mSectionMap.get(section)).add(item);
    }

    public void removeItem(String section, Area item) {
    ...
    private void generateDataList () {
        ...
        for (Map.Entry<Section, ArrayList<Area>> entry : mSectionDataMap.entrySet()) {
            Section key;
